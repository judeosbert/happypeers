        ...
        <main className="min-h-screen min-w-full bg-grey-500 text-primary-500 font-poppins">
          ...
          <section className='px-5 text-center'>
            ...
            <div className='mt-8 flex flex-col items-center gap-3 text-center'>
              ...
              <p className='font-thin px-5'><span className='font-semibold'>Take your step to happy employees</span> and get your organisation on the path to productivity</p>
            </div>
            <div className='min-w-full flex flex-row justify-center'>
              <img className='mt-6' src="../console_preview.png" />
            </div>
            <div className='mt-8 flex flex-col gap-4'>
              <h1 className='text-2xl font-bold'>Innovative Anonymous Feedback System powered by AI</h1>
              <p className='text-lg'>HappyPeers is an innovative feedback system for your organisation that encourages people to speak up, identify points of improvement for individuals for a happier workspace</p>
